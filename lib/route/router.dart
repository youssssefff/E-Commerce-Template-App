...
import 'package:shop/screens/auth/presentation/views/login_screen.dart';
import 'package:shop/screens/auth/presentation/views/otp_verification_screen.dart';
import 'package:shop/screens/auth/presentation/views/password_recovery_screen.dart';
import 'package:shop/screens/auth/presentation/views/reset_password_screen.dart';
import 'package:shop/screens/auth/presentation/views/signup_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case rootRoute:
      ...
      // If it's not the first time, check if the token and userId are available
      if ((token == null || userId == null) && !cacheHelper.isFirstTime()) {
      ...
      // If everything is fine, proceed to the main screen or dashboard
      return MaterialPageRoute(builder: (context) => const LoginScreen());
